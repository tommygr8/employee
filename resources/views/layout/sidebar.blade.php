<div class="nk-sidebar" data-content="sidebarMenu">
            ...
            <div class="nk-sidebar-body">
                    ...
                    <div class="nk-sidebar-menu">
                        ...
                        <ul class="nk-menu apps-menu">
                            <li class="nk-menu-item active">
                                <a href="#" class="nk-menu-link nk-menu-switch" data-target="navSearch">
                                    <span class="nk-menu-icon"><em class="icon ni ni-search"></em></span>
                                </a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="#" class="nk-menu-link nk-menu-switch" data-target="navCalendar">
                ...
                <div class="nk-sidebar-profile nk-sidebar-profile-fixed dropdown">
                    ...
                    <ul class="nk-menu apps-menu">
                        ...
                        <li class="nk-menu-item active">
                            <a href="#" class="nk-menu-link nk-menu-switch" data-target="navDashboards">
                                <span class="nk-menu-icon"><em class="icon ni ni-align-left"></em></span>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="nk-sidebar-main is-light">
        <div class="nk-sidebar-inner" data-simplebar>
            ...
            @php /*<div class="nk-menu-content" data-content="navApps">
